...
<html lang="en">
  ...
  <body background="https://i.pinimg.com/564x/03/1d/75/031d75d9a633a918c30d91b82c255f97.jpg">
      <div class="container">
        ...
        <form:form method="POST" action="${contextPath}/reset-password" modelAttribute="userForm" class="form-signin">
            ...
            <form:hidden path="resetPasswordStatus" value="${resetPasswordStatus}" />
