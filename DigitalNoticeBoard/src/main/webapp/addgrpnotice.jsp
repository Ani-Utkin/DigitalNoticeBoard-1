...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    <ul class="navbar-nav mr-auto">
      ...
      <li class="nav-item">
        <a class="nav-link" href="${contextPath}/${user.username}/${group.id}">${group.name}</a>
      </li>
    </ul>
...
<body>
<div class="container">
        <form:form method="POST" action="${contextPath}/${user.username}/${group.id}/addNotice" modelAttribute="noticeForm">
